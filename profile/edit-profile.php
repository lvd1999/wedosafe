    ...
    <div class="container-login100" style="background-image: url('../images/bg-01.jpg');">
        <div class="main">
            <div class="wrap-login100">
                <div class="container">
                    <button class="au-btn btn btn-warning btn-sm"><a href=" profile.php">Back </a></button>
                    <div class="container">
                        <span class="login100-form-logo float-right">
                            <div class="box1">
                                ...
                                <a class="info" onClick="triggerClick()"><button type="button"
                                        class="btn btn-primary btn-block">Change
                                        Avatar</button></a>
                            </div>
                        </span>
